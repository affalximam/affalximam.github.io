    ...
    <!-- end navbar -->
            ...
            <div class="container">
              <div class="row justivy-content-center m-auto">
                ...
                <div  class="col-sm-3 justify-content-end"
                      ...
                      data-aos-duration="1500"
                      data-aos-delay="500">
                  <a href="#" class="btn btn-primary btn-lg btn-1 m-3">Hire Me
                  </a>
                </div>
                <div  class="col-sm-3 justify-content-start"
                      ...
                      data-aos-duration="1500"
                      data-aos-delay="500">
                  <a href="#?id=3" class="btn btn-primary btn-lg btn-1 m-3 page-scroll">View Blog
                  </a>
                </div>
              </div>
            </div>
      ...
      <section id="?id=3" class="tools">
        <div class="row pt-5 pb-5 text-center tools-1">
          <h2 class="mt-3"
              data-aos="fade-in"
              data-aos-anchor-placement="center-bottom">Blog</h2>
        </div>
          <div class="row blog-2 p-5">
            <a  href="read/internet.php?id=1" class="card card-tools mb-3"
                data-aos="fade-right"
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <p>
                    ...
                    Internet di era digital saat ini sangat erat kaitannya dalam kehidupan sehari – hari.
                  </p>
                </div>
              </div>
            </a>
            <a  href="read/manfaat internet.php?id=2" class="card card-tools mb-3"
                data-aos="fade-left"
                data-aos-anchor-placement="center-bottom">
              <div class="row">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <p>
                    <h2>Manfaat internet</h2>
                    Banyak sekali manfaat internet dalam kehidupan sehari – hari. Berikut ini merupakan beberapa manfaat....
                  </p>
                </div>
              </div>
            </a>
            <a  href="read/sisi gelap internet.php?id=3" class="card card-tools mb-3"
                data-aos="fade-right"
                data-aos-anchor-placement="center-bottom">
              <div class="row">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <p>
                    <h2>Sisi Gelap internet</h2>
                    Jika pada umumnya kita menggunakan internet untuk mencari sesuatu, kemudian sesuatu tersebut tidak ada.
                  </p>
                </div>
              </div>
            </a>
            <a  href="read/Pengertian, Jenis, Serta Manfaat Website.php?id=4" class="card card-tools mb-3"
                data-aos="fade-left"
                data-aos-anchor-placement="center-bottom">
              <div class="row">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <p>
                    <h2>Pengertian, Jenis, Serta Manfaat Website</h2>
                    Situs web atau website adalah kumpulan informasi dalam bentuk halaman web yang saling tergabung di sebuah domain atau URL.
                  </p>
                </div>
              </div>
            </a>
            <a  href="read/pengertian bahasa pemrograman.php" class="card card-tools mb-3"
                data-aos="fade-right"
                data-aos-anchor-placement="center-bottom">
              <div class="row">
                <div class="col-sm-2">
